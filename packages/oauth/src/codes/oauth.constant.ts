...
export const OAuthCode = {
  ...
  MERGE_REQUEST_CREATION_FAILED: 'OAUTH_210',
  MERGE_EMAIL_SEND_FAILED: 'OAUTH_211',
  MERGE_TOKEN_INVALID_OR_EXPIRED: 'OAUTH_212',
  MERGE_EXECUTION_FAILED: 'OAUTH_213',
  MERGE_CANNOT_CANCEL: 'OAUTH_214',
  MERGE_REQUEST_NOT_FOUND: 'OAUTH_215',
