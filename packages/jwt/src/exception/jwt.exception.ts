...
export class JwtException {
  ...
  static configMissing(type: JwtTokenType): HttpException {
  ...
  static privateKeyMissing(type: JwtTokenType): HttpException {
  ...
  static publicKeyMissing(type: JwtTokenType): HttpException {
  ...
  static expireMissing(type: JwtTokenType): HttpException {
  ...
  /** 토큰 생성(서명) 실패 */
  static signFailure(type: JwtTokenType): HttpException {
  ...
  /** 토큰 복호화 실패 */
  static decryptionFailed(type: JwtTokenType): HttpException {
  ...
  /** 토큰이 존재하지 않음 */
  static notFound(type: JwtTokenType): HttpException {
  ...
  /** 토큰이 유효하지 않거나 만료됨 */
  static invalid(type: JwtTokenType): HttpException {
  ...
  static expired(type: JwtTokenType): HttpException {
  ...
  static malformed(type: JwtTokenType): HttpException {
  ...
  static unsupported(type: JwtTokenType): HttpException {
